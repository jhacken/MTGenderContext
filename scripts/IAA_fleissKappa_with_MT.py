...
# Define function to calculate Fleiss Kappa between annotators and the MT
# The function prints each IAA value between each pair and a total average
def calculate_fleiss_kappa_with_MT(data):
